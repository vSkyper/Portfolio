    ...
    <main className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-black text-white">
      ...
      >
        <m.div variants={slideInTopAnimation} className="mb-6 relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 shadow-lg shadow-black/5">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 sm:w-200 sm:h-200 bg-red-500/5 rounded-full blur-[100px] sm:blur-[120px] pointer-events-none -z-10" />
    </main>
  );
}
