    ...
    <>
      ...
      >
        <img
          src={thumbnailSrc}
          alt='project'
          className='w-full h-[200px] sm:h-[300px] md:h-[400px] object-cover rounded-3xl outline-none will-change-transform group-hover:opacity-80 transition-opacity duration-200 pointer-events-none'
