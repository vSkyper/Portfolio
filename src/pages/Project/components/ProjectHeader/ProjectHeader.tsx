...
export default function ProjectHeader({
  ...
  return (
    ...
    >
      <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/3 border border-white/10 shadow-sm">
      ...
      <div className="prose prose-invert max-w-none">
        <div className="text-sm sm:text-base text-white/70 leading-relaxed max-w-2xl font-medium">
