...
export default function Technology(props: TechnologyProps) {
  ...
  return (
    <div className='group relative text-xs sm:text-sm font-medium py-1.5 px-3 sm:py-2 sm:px-4 rounded-full bg-white/5 ring-1 ring-white/10 backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:ring-primary/50 hover:shadow-[0_0_15px_rgba(122,181,220,0.2)] cursor-default select-none'>
