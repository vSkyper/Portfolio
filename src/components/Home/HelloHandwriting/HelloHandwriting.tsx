export default function HelloHandwriting() {
  return (
    <svg
      transform='scale(0.9)'
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stop-color='#0B7E95' />
          <stop offset='.3' stop-color='#FFAB45' />
          <stop offset='.6' stop-color='#F55644' />
          <stop offset='.9' stop-color='#7AB5DC' />
        </linearGradient>
      </defs>
    </svg>
  );
